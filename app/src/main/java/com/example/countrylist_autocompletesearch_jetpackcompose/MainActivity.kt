package com.example.countrylist_autocompletesearch_jetpackcompose
...
import com.example.countrylist_autocompletesearch_jetpackcompose.ui.theme.CountryListAutoCompleteSearchjetPackComposeTheme
import com.example.countrylist_autocompletesearch_jetpackcompose.ui.theme.Purple500
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CountryListAutoCompleteSearchjetPackComposeTheme {
                Scaffold(topBar = { TopBar() }, backgroundColor = Purple500) {
                    CountryNavigation()
                }
            }
        }
...
fun searchCountryList(textVal: MutableState<TextFieldValue>) {
    TextField(
        ...
        placeholder = { Text(text = "Search Country Name", color = Color.Black) },
        modifier = Modifier
            .fillMaxWidth(),
